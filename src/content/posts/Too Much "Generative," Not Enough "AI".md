...
Except... they have really haven't. Law offices and doctors still have secretaries—when is the last time you scheduled a physical by having a phone call with an MD?

So no, secretaries have not been made obsolete. To the contrary: technology has allowed all of us to have *our own* secretary—ourselves! All we need to do is use a bunch of apps.
...
So, it seems we can't get rid of this work. But hey, at least we have convenient *appliances* for completing it—that is, apps. And really, what could be more convenient than an app?
...
When people talk about "prompt engineering," it often seems like they are talking about engineering a singular prompt to set the conversation up just-so, like selecting the right K-cup to place in the Keurig to produce the perfect cup of coffee. [Long, complex, up-front prompts can certainly generate impressive results](https://martinfowler.com/articles/2023-chatgpt-xu-hao.html "An Example of LLM Prompting for Programming"). But I argue that approaching ChatGPT in this way actually underestimates what it can do.

In ChatGPT, unlike Midjourney, you aren't restricted to "engineering" a single perfect prompt in order to generate a single perfect output.[^3] That's what the "Chat" part of the name means: over the course of *many* prompts—AKA a conversation—you can teach ChatGPT to behave as a trained, knowledgeable assistant that knows how to work for *you*.

My point here is that, at least in the case of ChatGPT, the top-heavy prompt engineering paradigm lacks imagination. You *can* frontload a big prompt that sets ChatGPT up as a certain kind of appliance. But you can *also* have a dialogue with it, in which it learns about what you want, and—crucially—you learn about what it can do.
